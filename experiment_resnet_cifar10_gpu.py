...
import dill
branchyNet.to_cpu()
with open("_models/resnet_cifar10_GPU.bn", "w") as f:
    dill.dump(branchyNet, f)
with open("_models/resnet_cifar10_results_GPU_(Train-main-branch).pkl", "w") as f:
...
branchyNet.to_cpu()
with open("_models/resnet_cifar10_results_GPU_(Test).pkl", "w") as f:
...
# (GPU-Visualizing)                              our_label='BranchyResNet', orig_label='ResNet', xlabel='Runtime (ms)',
# (GPU-Visualizing)                              title='ResNet GPU', output_path='_figs/resnet_gpu.pdf')
...
# (CPU-Visualizing)                              our_label='BranchyResNet', orig_label='ResNet', xlabel='Runtime (ms)',
# (CPU-Visualizing)                              title='ResNet CPU', output_path='_figs/resnet_cpu.pdf')
...
# with open("_models/resnet_cifar10_GPU.bn", "w") as f:
#     dill.dump(branchyNet, f)
# with open("_models/resnet_cifar10_results_GPU.pkl", "w") as f:
#     dill.dump({'main_loss': main_loss, 'main_acc': main_acc, 'main_time': main_time, 'branch_loss': branch_loss,
